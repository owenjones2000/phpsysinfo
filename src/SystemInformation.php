    ...
    private function readConfig()
    {
        if (!defined('PSI_CONFIG_FILE')) {
            ...
            if (!defined('PSI_OS')) { //if not overloaded in phpsysinfo.ini
                ...
                if (PHP_OS == 'Linux') {
                    if (
                        file_exists($fname = '/etc/sysconfig/i18n')
                    ...
                    if (
                        !(defined('PSI_SYSTEM_CODEPAGE') && defined('PSI_SYSTEM_LANG')) //also if both not overloaded in phpsysinfo.ini
                        ...
                        if (!defined('PSI_SYSTEM_CODEPAGE')) {
                            if (
                                file_exists($vtfname = '/sys/module/vt/parameters/default_utf8')
                    ...
                    if (
                        !defined('PSI_SYSTEM_LANG') //if not overloaded in phpsysinfo.ini
